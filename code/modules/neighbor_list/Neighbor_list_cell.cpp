...
void Neighbor_list_cell::init_verlet_list(YAML::Node& doc, particles_instance& particles) {
    int N = particles.N;
    int max_neighbors;
...
void Neighbor_list_cell::build_verlet_list(particles_instance& particles) {
...
void Neighbor_list_cell::build_initial_cell_list(particles_instance& particles) {
